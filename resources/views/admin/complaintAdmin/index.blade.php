                            ...
                            <tbody>
                                @forelse($complaints as $complaint)
                                    <tr>
                                        ...
                                        <td>
                                            @if($complaint->status_changed_at)
                                                {{ $complaint->status_changed_at->timezone(config('app.timezone'))->format('M d, Y') }}
                                                <div class="small text-muted">({{ $complaint->status_changed_at->timezone(config('app.timezone'))->diffForHumans() }})</div>
                                            @else
                                                {{ $complaint->created_at->timezone(config('app.timezone'))->format('M d, Y') }}
                                                <div class="small text-muted">({{ $complaint->created_at->timezone(config('app.timezone'))->diffForHumans() }})</div>
                                            @endif
                                        </td>
                                        <td>
                                            <div class="d-flex gap-2">
...
/* alternate row background like the screenshot */
